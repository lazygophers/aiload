...
type ModelChannel struct {
	...
	// @gorm: index: idx_channel,unique
	Token string `protobuf:"bytes,6,opt,name=token,proto3" json:"token,omitempty" toml:"token,omitempty" gorm:"default:'';column:token;index:idx_channel,unique;type:varchar(255);not null" yaml:"token,omitempty"`
	// @gorm: index: idx_channel,unique
	Platform Platform `protobuf:"varint,7,opt,name=platform,proto3,enum=aiload.Platform" json:"platform,omitempty" yaml:"platform,omitempty" toml:"platform,omitempty" gorm:"index:idx_channel,unique;not null;default:0;column:platform"`
}
...
type ModelUserToken struct {
	...
	// gorm: index:idx_token,unique
	Token string `protobuf:"bytes,6,opt,name=token,proto3" json:"token,omitempty" toml:"token,omitempty" gorm:"not null;default:'';column:token;type:varchar(255)" yaml:"token,omitempty"`
	Limit int64  `protobuf:"varint,7,opt,name=limit,proto3" json:"limit,omitempty" toml:"limit,omitempty" gorm:"not null;default:0;column:limit" yaml:"limit,omitempty"`
}
...
type ModelUserAccess struct {
	...
	DeletedAt int64 `protobuf:"varint,4,opt,name=deleted_at,json=deletedAt,proto3" json:"deleted_at,omitempty" toml:"deleted_at,omitempty" gorm:"column:deleted_at;not null;default:0;index:idx_user_access,unique" yaml:"deleted_at,omitempty"`
	// @gorm: index:idx_user_access,unique
	...
	// @gorm: index:idx_user_access,unique
	Model string `protobuf:"bytes,6,opt,name=model,proto3" json:"model,omitempty" yaml:"model,omitempty" toml:"model,omitempty" gorm:"default:'';column:model;index:idx_user_access,unique;type:varchar(255);not null"`
}
...
type ListUserAdminRsp struct {
	...
	List     []*ModelUser   `protobuf:"bytes,2,rep,name=list,proto3" json:"list,omitempty" yaml:"list,omitempty" toml:"list,omitempty" gorm:"serializer:json;column:list;type:json"`
}
...
type LoginReq struct {
	...
	// @validate: required
	Username string `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty" yaml:"username,omitempty" toml:"username,omitempty" gorm:"column:username;type:varchar(255);not null;default:''" validate:"required"`
	// @validate: required
...
var file_aiload_proto_rawDesc = []byte{
	...
	,
	...
	0x42, 0x0c, 0x5a, 0x07, 0x2f, 0x61, 0x69, 0x6c, 0x6f, 0x61, 0x64, 0xf8, 0x01, 0x01, 0x62, 0x06,
...
var file_aiload_proto_depIdxs = []int32{
	...
	2,  // 1: aiload.ModelUser.role:type_name -> aiload.UserRole
