...
type ModelChannel struct {
	...
	Name      string `protobuf:"bytes,5,opt,name=name,proto3" json:"name,omitempty" yaml:"name,omitempty" toml:"name,omitempty" gorm:"column:name;type:varchar(255);not null;default:''"`
	// @gorm: index: idx_channel,unique
...
type ModelModelAlias struct {
	...
	// gorm: index:idx_alias,unique
	ModelAlias string `protobuf:"bytes,6,opt,name=model_alias,json=modelAlias,proto3" json:"model_alias,omitempty" toml:"model_alias,omitempty" gorm:"default:'';column:model_alias;type:varchar(255);not null" yaml:"model_alias,omitempty"`
}
...
type ModelUser struct {
	...
	Name     string `protobuf:"bytes,7,opt,name=name,proto3" json:"name,omitempty" yaml:"name,omitempty" toml:"name,omitempty" gorm:"column:name;type:varchar(255);not null;default:''"`
}
...
type ModelUserToken struct {
	...
	Id        uint64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty" toml:"id,omitempty" gorm:"autoIncrement;AUTOINCREMENT;column:id;primaryKey;PRIMARY KEY" yaml:"id,omitempty"`
	CreatedAt int64  `protobuf:"varint,2,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty" yaml:"created_at,omitempty" toml:"created_at,omitempty" gorm:"autoCreateTime;column:created_at;not null;default:0"`
	UpdatedAt int64  `protobuf:"varint,3,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty" yaml:"updated_at,omitempty" toml:"updated_at,omitempty" gorm:"autoUpdateTime;column:updated_at;not null;default:0"`
...
type ModelUserAccess struct {
	...
	// @gorm: index:idx_user_access,unique
	Model string `protobuf:"bytes,6,opt,name=model,proto3" json:"model,omitempty" gorm:"type:varchar(255);not null;default:'';column:model;index:idx_user_access,unique" yaml:"model,omitempty" toml:"model,omitempty"`
}
...
type SetUserReq struct {
	...
	// @validate: required
	User *ModelUser `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty" toml:"user,omitempty" gorm:"serializer:json;column:user;type:json" validate:"required" yaml:"user,omitempty"`
}
