...
func (p *Gemini) GetModelList() (*GeminiGetModelListRsp, error) {
	...
	if resp.IsError() {
		err = fmt.Errorf("Gemini api error: %s", resp.String())
...
func (p *Gemini) GetRequest() *resty.Request {
	return client.R().SetQueryParam("key", p.channel.Token)
}
...
func (p *Gemini) GetModel(ctx context.Context, req *GeminiGetModelReq) (*GeminiGetModelRsp, error) {
	...
	resp, err := p.GetRequest().Get(p.channel.BaseUrl + "/v1/models/" + req.Model)
	if err != nil {
		log.Errorf("error: %s", err)
		return nil, err
	}
...
func (p *Gemini) CountTokens(ctx context.Context, req *GeminiCountTokensReq) (*GeminiCountTokensRsp, error) {
	...
	resp, err := p.GetRequest().SetBody(req).Post(p.channel.BaseUrl + "/v1/models/" + req.Model + ":countTokens")
	if err != nil {
		log.Errorf("error: %s", err)
		return nil, err
	}
...
func (p *Gemini) EmbedContent(ctx context.Context, req *GeminiEmbedContentReq) (*GeminiEmbedContentRsp, error) {
	...
	resp, err := p.GetRequest().SetBody(req).Post(p.channel.BaseUrl + "/v1/models/" + req.Model + ":embedContent")
	if err != nil {
		log.Errorf("error: %s", err)
		return nil, err
	}
...
func (p *Gemini) BatchEmbedContents(ctx context.Context, req *GeminiBatchEmbedContentsReq) (*GeminiBatchEmbedContentsRsp, error) {
	...
	resp, err := p.GetRequest().SetBody(req).Post(p.channel.BaseUrl + "/v1/models/" + model + ":batchEmbedContents")
	if err != nil {
		log.Errorf("error: %s", err)
		return nil, err
	}
...
func (p *Gemini) GenerateContent(ctx context.Context, model string, req *GeminiGenerateContentReq) (*GeminiGenerateContentRsp, error) {
	...
	resp, err := p.GetRequest().SetBody(req).Post(p.channel.BaseUrl + "/v1/models/" + model + ":generateContent")
	if err != nil {
		log.Errorf("error: %s", err)
		return nil, err
	}
...
func (p *Gemini) StreamGenerateContent(ctx context.Context, model string, req *GeminiGenerateContentReq) (<-chan *GeminiGenerateContentRsp, error) {
	...
	go func() {
		...
		request := p.GetRequest().SetBody(req)
