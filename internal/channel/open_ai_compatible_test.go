...
func setupOpenAICompatibleTest(t *testing.T) (*OpenAICompatible, func()) {
	t.Helper()
	...
	mux.HandleFunc("/v1/models", func(w http.ResponseWriter, r *http.Request) {
		...
		rsp := OpenAICompatibleGetModelListRsp{
			Object: "list",
			Data: []struct {
				Id      string `json:"id"`
				...
				{Id: "gpt-4", Object: "model", Created: 1677610602, OwnedBy: "OpenAICompatible"},
			},
		}
	...
	mux.HandleFunc("/v1/chat/completions", func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		rsp := OpenAICompatibleCreateChatCompletionRsp{
			Id:      "chatcmpl-123",
	...
	mux.HandleFunc("/v1/completions", func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		rsp := OpenAICompatibleCreateCompletionRsp{
			Id:      "cmpl-123",
	...
	mux.HandleFunc("/v1/embeddings", func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		rsp := OpenAICompatibleCreateEmbeddingRsp{
			Object: "list",
			Data: []struct {
				Object    string    `json:"object"`
	...
	mux.HandleFunc("/v1/fine_tuning/jobs", func(w http.ResponseWriter, r *http.Request) {
		...
		if r.Method == http.MethodPost {
			rsp := OpenAICompatibleFineTuningJob{Id: "ftjob-abc123", Status: "succeeded"}
			json.NewEncoder(w).Encode(rsp)
			return
		}
		rsp := OpenAICompatibleListFineTuningJobsRsp{
			Object:  "list",
			Data:    []OpenAICompatibleFineTuningJobEvent{{Message: "job event"}},
			HasMore: false,
		}
		json.NewEncoder(w).Encode(rsp)
	})
	...
	mux.HandleFunc("/v1/images/generations", func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		rsp := OpenAICompatibleImageRsp{Created: 1677652288, Data: []struct {
			Url     string `json:"url"`
	...
	mux.HandleFunc("/v1/files", func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		if r.Method == http.MethodPost {
			rsp := OpenAICompatibleFile{Id: "file-uploaded", Object: "file"}
			json.NewEncoder(w).Encode(rsp)
			return
		}
		rsp := OpenAICompatibleListFilesRsp{Object: "list", Data: []OpenAICompatibleFile{{Id: "file-abc123"}}}
		json.NewEncoder(w).Encode(rsp)
	})
	...
	mux.HandleFunc("/v1/files/file-abc123", func(w http.ResponseWriter, r *http.Request) {
		...
		if r.Method == http.MethodDelete {
			rsp := OpenAICompatibleDeleteFileRsp{Id: "file-abc123", Object: "file", Deleted: true}
			json.NewEncoder(w).Encode(rsp)
			return
		}
		rsp := OpenAICompatibleFile{Id: "file-abc123", Object: "file"}
		json.NewEncoder(w).Encode(rsp)
	})
	...
	mux.HandleFunc("/v1/audio/transcriptions", func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		rsp := OpenAICompatibleCreateTranscriptionRsp{Text: "This is a transcription."}
		json.NewEncoder(w).Encode(rsp)
	})
	...
	mux.HandleFunc("/v1/audio/translations", func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		rsp := OpenAICompatibleCreateTranslationRsp{Text: "This is a translation."}
		json.NewEncoder(w).Encode(rsp)
	})
	...
	mux.HandleFunc("/v1/fine_tuning/jobs/ftjob-abc123/cancel", func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		rsp := OpenAICompatibleFineTuningJob{Id: "ftjob-abc123", Status: "cancelled"}
		json.NewEncoder(w).Encode(rsp)
	})
	...
	mux.HandleFunc("/v1/fine_tuning/jobs/ftjob-abc123/events", func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		rsp := OpenAICompatibleListFineTuningEventsRsp{
			Object: "list",
			Data:   []OpenAICompatibleFineTuningJobEvent{{Message: "event message"}},
		}
		json.NewEncoder(w).Encode(rsp)
	})
	...
	mux.HandleFunc("/v1/models/gpt-4", func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		rsp := OpenAICompatibleModel{Id: "gpt-4", Object: "model"}
		json.NewEncoder(w).Encode(rsp)
	})
	...
	mux.HandleFunc("/v1/models/ft:gpt-3.5-turbo", func(w http.ResponseWriter, r *http.Request) {
		...
		w.Header().Set("Content-Type", "application/json")
		rsp := OpenAICompatibleDeleteModelRsp{Id: "ft:gpt-3.5-turbo", Deleted: true}
		json.NewEncoder(w).Encode(rsp)
	})

	server := httptest.NewServer(mux)

	OpenAICompatibleClient := NewOpenAICompatible(&aiload.ModelChannel{
		Token:   "test-token",
		BaseUrl: server.URL,
	})

	return OpenAICompatibleClient, func() {
		server.Close()
	}
}

func TestOpenAICompatible_GetModelList(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		testClient, teardown := setupOpenAICompatibleTest(t)
		defer teardown()
...
func TestOpenAICompatible_CreateChatCompletion(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		testClient, teardown := setupOpenAICompatibleTest(t)
		defer teardown()

		req := &OpenAICompatibleCreateChatCompletionReq{
			Model: "gpt-4",
	...
	t.Run("APIError", func(t *testing.T) {
		...
		req := &OpenAICompatibleCreateChatCompletionReq{Model: "gpt-4"}
		rsp, err := testClient.CreateChatCompletion(req)
		assert.Error(t, err)
		assert.Nil(t, rsp)
	})
...
func TestOpenAICompatible_CreateCompletion(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		testClient, teardown := setupOpenAICompatibleTest(t)
		defer teardown()

		req := &OpenAICompatibleCreateCompletionReq{
			Model:  "gpt-3.5-turbo-instruct",
	...
	t.Run("APIError", func(t *testing.T) {
		...
		req := &OpenAICompatibleCreateCompletionReq{Model: "gpt-3.5-turbo-instruct"}
		rsp, err := testClient.CreateCompletion(req)
		assert.Error(t, err)
		assert.Nil(t, rsp)
	})
...
func TestOpenAICompatible_CreateEmbedding(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		testClient, teardown := setupOpenAICompatibleTest(t)
		defer teardown()

		req := &OpenAICompatibleCreateEmbeddingReq{
			Model: "text-embedding-ada-002",
	...
	t.Run("APIError", func(t *testing.T) {
		...
		req := &OpenAICompatibleCreateEmbeddingReq{Model: "text-embedding-ada-002"}
		rsp, err := testClient.CreateEmbedding(req)
		assert.Error(t, err)
		assert.Nil(t, rsp)
	})
...
func TestOpenAICompatible_CreateSpeech(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		testClient, teardown := setupOpenAICompatibleTest(t)
		defer teardown()

		req := &OpenAICompatibleCreateSpeechReq{
			Model: "tts-1",
			Input: "Hello world",
			Voice: "alloy",
		}
	...
	t.Run("APIError", func(t *testing.T) {
		...
		req := &OpenAICompatibleCreateSpeechReq{Model: "tts-1"}
		rsp, err := testClient.CreateSpeech(req)
		assert.Error(t, err)
		assert.Nil(t, rsp)
	})
...
func TestOpenAICompatible_CreateTranscription(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		testClient, teardown := setupOpenAICompatibleTest(t)
		defer teardown()
...
func TestOpenAICompatible_CreateTranslation(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		testClient, teardown := setupOpenAICompatibleTest(t)
		defer teardown()
...
func TestOpenAICompatible_FineTuning(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		// Create
		createReq := &OpenAICompatibleCreateFineTuningJobReq{
	...
	t.Run("APIError", func(t *testing.T) {
		...
		_, err := testClient.CreateFineTuningJob(&OpenAICompatibleCreateFineTuningJobReq{})
		assert.Error(t, err)
...
func TestOpenAICompatible_Images(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		testClient, teardown := setupOpenAICompatibleTest(t)
		defer teardown()

		// Create
		createReq := &OpenAICompatibleCreateImageReq{
	...
	t.Run("APIError", func(t *testing.T) {
		...
		_, err := testClient.CreateImage(&OpenAICompatibleCreateImageReq{})
		assert.Error(t, err)
...
func TestOpenAICompatible_Files(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		testClient, teardown := setupOpenAICompatibleTest(t)
		defer teardown()
...
func TestOpenAICompatible_Models(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		testClient, teardown := setupOpenAICompatibleTest(t)
		defer teardown()
